...
namespace Traffic
{
    public partial class Localization
    {
        ...
        internal static void LoadLocales(Game.Modding.IMod mod, float refTranslationCount)
        {
        ...
        internal static void LocalizationExport(Game.Modding.IMod mod, ModSettings settings)
        {
            if (GameManager.instance.modManager.TryGetExecutableAsset(mod, out var asset))
            {
